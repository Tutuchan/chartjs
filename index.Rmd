...
Legends are automatically generated and placed in a separate container next to the graph.

### Future improvements

There are several things on my todo list : 

+ I am currently working on implementing the v2.0 of Chart.js which is still under heavy development, 
expect a lot of changes in the upcoming versions. This work can be seen in the *dev* branch,
...
+ a better definition of the inputs for a graph, possibly using NSE.
...
+ the RStudio team for the [rmarkdown](http://rmarkdown.rstudio.com/) package and the website template that I shamelessly ripped.